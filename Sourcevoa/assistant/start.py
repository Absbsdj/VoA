...
from SourceVoA import bot
from SourceVoA.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from SourceVoA.sql_helper.botusers_sql import add_me_in_db, his_userid
from SourceVoA.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/X_Y1I"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب VoA  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/X_Y1I")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/X_YI1I")],
                [Button.url("كروب المساعدة ❓", "https://t.me/zzzyztt")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @X_Y1I", alert=True)
